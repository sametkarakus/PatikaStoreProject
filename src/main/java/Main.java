            ...
            if(option == 0) {
                ...
                switch(choice) {
                    ...
                    case 2:
                        ...
                        if(added) {
                            System.out.println("Product basariyla eklendi.");
                        }
                        break;
                    case 3:
                        patikaStore.notebooklariListele();
                        ...
                        if(deleted) {
                            System.out.println("Product basariyla silindi.");
                        }
                        break;
                    default:
                ...
                switch(choice) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        boolean added = patikaStore.urunEkle("MobilePhone");
                        if(added) {
                            System.out.println("Product basariyla eklendi.");
                        }
                        break;
                    case 3:
                        ...
                        System.out.print("Silmek istediginiz urunun id'sini giriniz : ");
                        int urunId = scanner.nextInt();
                        boolean deleted = patikaStore.urunSil("MobilePhone", urunId);
                        if(deleted) {
                            System.out.println("Product basariyla silindi.");
                        }
                        break;
